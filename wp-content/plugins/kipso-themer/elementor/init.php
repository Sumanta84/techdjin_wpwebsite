...
if(!class_exists('GVA_Elementor_Addons')){
  class GVA_Elementor_Addons {
    ...
    public function include_elements($widgets_manager) {
      ...
      $widgets_manager->register(new GVAElement_Icon_Box_Carousel());
      ...
      $widgets_manager->register(new GVAElement_Courses());

      require 'elements/gva-tabs-color.php';
      $widgets_manager->register(new GVAElement_Tabs_Color());
