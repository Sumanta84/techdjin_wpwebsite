...
?>
  ...
  <div <?php echo $this->get_render_attribute_string('wrapper'); ?>>
    <?php if($settings['isotope_filter'] == 'yes'){ ?>
      <?php 
        $terms = get_terms('course_category', array('orderby'=>'id'));
      ...
      ?>
       <nav class="portfolio-filter">
          <ul class="nav nav-tabs">
             <li><a class="btn-filter all active" href="javascript:void(0)" data-filter="*"><span><?php echo esc_html__( 'All', 'kipso-themer' ); ?></span></a></li>
             <?php 
      ...
      <div <?php echo $this->get_render_attribute_string('grid') ?>>
        <?php
          ...
          while ( $query->have_posts() ) { 
            ...
            get_template_part('learnpress/content', $settings['style'] );
          }
        ?>
      </div>
    </div>
