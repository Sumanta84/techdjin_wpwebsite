<?php
class Gavias_Themer_Comment{

  public static $instance;

  public static function getInstance() {
    if (!isset(self::$instance) && !(self::$instance instanceof Gavias_Themer_Comment)) {
      self::$instance = new Gavias_Themer_Comment();
    }
