...
class Gavias_Themer_Footer{
  ...
  public function args_post_type_footer(){
    ...
    //             'title' => __('Edit Footer', 'kipso-themer'),
  ...
  public function get_footers(){
    ...
    $footers['__default_option_theme'] = esc_html__('Default Option Theme', 'kipso');
    $footers['__disable_footer'] = esc_html__('Disable Footer', 'kipso');
    $footers['__default'] = __('Default Widget Footer', 'kipso-themer');
    wp_reset_postdata();
