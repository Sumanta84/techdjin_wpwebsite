...
class Gavias_Themer_Header{
  ...
  public function render_header_builder($header_slug) {
    ...
    if ($header && $header instanceof WP_Post && isset($header->ID)) {
      if (function_exists('is_plugin_active') && is_plugin_active( 'elementor/elementor.php' ) && class_exists('Elementor\Plugin')) {
