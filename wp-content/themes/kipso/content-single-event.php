<?php
	...
	$start_time = get_post_meta($event_id, 'kipso_start_time', true );
	...
	$finish_time = get_post_meta($event_id, 'kipso_finish_time', true );
	...
	$address = get_post_meta($event_id, 'kipso_address', true );
...
<article id="event-<?php the_ID(); ?>" <?php post_class( 'event-single' ); ?>>
	...
	<div class="event-content entry-content">
			...
			<div class="block-content">
				<?php if($start_time){ ?>
					<div class="info-item">
	              	...
	              	<div class="content">
	                	<span class="lab"><?php echo esc_html__( 'Start time', 'kipso' ); ?></span>
	                	<span class="val">
				...
				<?php if($finish_time){ ?>
					<div class="info-item">
	              	...
	              	<div class="content">
	                	<span class="lab"><?php echo esc_html__( 'Finished Time', 'kipso' ); ?></span>
	                	<span class="val">
				...
				<?php if($address){ ?>
					<div class="info-item">
	              	...
	              	<div class="content">
	                	<span class="lab"><?php echo esc_html__( 'Address', 'kipso' ); ?></span>
	                	<span class="val">
		...
		<?php if($speakers){ ?>
			<div class="meta-block speakers">
				<div class="block-title"><?php echo esc_html__( 'Speakers', 'kipso' ); ?></div>
				<div class="block-content">
		...
		<div class="meta-block">
			<div class="block-title"><?php echo esc_html__( 'Content', 'kipso' ); ?></div>
	...
	<?php if($address){ ?>
	<?php
		$map_api_key = kipso_get_option('map_api_key', '');
	?>
	<div class="event-map">
		<?php
			$args = array(
			...
			echo rwmb_meta( 'kipso_map', $args, $event_id ); 
		?>
	</div>
	<?php } ?>
	<div class="row">
