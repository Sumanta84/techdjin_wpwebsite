...
<div class="learn-press-subtab-content">
	...
	<?php if ( $query->get_items() ) : ?>
		<table class="lp-list-table profile-list-quizzes profile-list-table">
			<thead>
				<tr>
					<th class="column-quiz"><?php esc_html_e( 'Quiz', 'kipso' ); ?></th>
					<th class="column-status"><?php esc_html_e( 'Result', 'kipso' ); ?></th>
					<th class="column-time-interval"><?php esc_html_e( 'Time spent', 'kipso' ); ?></th>
					<th class="column-date"><?php esc_html_e( 'Date', 'kipso' ); ?></th>
				</tr>
			</thead>
