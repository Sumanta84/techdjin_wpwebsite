...
<form class="lp-form form-button form-button-finish-course" method="post" data-confirm="<?php echo LP_Strings::esc_attr( 'confirm-finish-course', '', array( $course->get_title() ) ); ?>" data-title="<?php echo esc_attr__( 'Finish course', 'kipso' ); ?>">
	<button class="lp-button lp-btn-finish-course"><?php esc_html_e( 'Finish course', 'kipso' ); ?></button>
