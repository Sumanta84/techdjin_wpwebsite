...
$start_time = get_post_meta(get_the_id(), 'kipso_start_time', true );
$finish_time = get_post_meta(get_the_id(), 'kipso_finish_time', true );
$address = get_post_meta(get_the_id(), 'kipso_address', true );
$event_time = get_post_meta( get_the_id(), 'kipso__time', true );
$event_color = get_post_meta( get_the_id(), 'kipso_event_color', true );
