<?php 
   $images = get_post_meta( get_the_ID(), 'kipso_gallery_images' , false );
   $extra_link = get_post_meta(get_the_ID(), 'kipso_service_extra_link', true);
   ...
   <div class="service-block service-item-v1">      
      ...
      <div class="service-content">
         <div class="content-inner">
            ...
            <div class="desc"><?php kipso_limit_words($excerpt_words, get_the_excerpt(), get_the_content()); ?></div> 
            <div class="readmore">
               <a href="<?php echo esc_url($service_link) ?>"><?php echo esc_html__('Read More', 'kipso'); ?></a>
            </div>
         </div>    
      </div>
   </div>
